...
function generateInstruction(actions, mediaTypes) {
    if (!actions || !mediaTypes || !Array.isArray(actions) || !Array.isArray(mediaTypes)) return `Argumen tidak valid.`;
...
function generateNotes(notes) {
    if (!notes || !Array.isArray(notes)) return `Catatan tidak valid.`;
    return "Catatan:\n" +
